...
import type { DexV2Market, DexV2MarketInterface } from '../DexV2Market';
...
export class DexV2Market__factory {
  static readonly abi = _abi;
  static createInterface(): DexV2MarketInterface {
    return new utils.Interface(_abi) as DexV2MarketInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): DexV2Market {
    return new Contract(address, _abi, signerOrProvider) as DexV2Market;
  }
}
