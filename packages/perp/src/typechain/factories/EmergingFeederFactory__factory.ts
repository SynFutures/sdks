...
import type { EmergingFeederFactory, EmergingFeederFactoryInterface } from '../EmergingFeederFactory';
...
export class EmergingFeederFactory__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): EmergingFeederFactory {
    return new Contract(address, _abi, signerOrProvider) as EmergingFeederFactory;
  }
}
