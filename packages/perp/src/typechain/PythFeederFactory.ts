...
export type SetPythAddressEvent = TypedEvent<[string], SetPythAddressEventObject>;
...
export interface PythFeederFactory extends BaseContract {
    ...
    filters: {
        ...
        FeederCreated(feeder?: PromiseOrValue<string> | null, symbolHash?: null): FeederCreatedEventFilter;
