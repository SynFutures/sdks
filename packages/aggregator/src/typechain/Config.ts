...
export interface Config extends BaseContract {
  ...
  populateTransaction: {
    ...
    addPools(pools: Config.PoolInputStruct[], overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
    ...
    initialize(_owner: string, _bot: string, overrides?: Overrides & { from?: string }): Promise<PopulatedTransaction>;
    ...
    poolList(arg0: string, arg1: string, arg2: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
